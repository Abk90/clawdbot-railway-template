...
const GOTION_SYSTEM_PROMPT = [
  ...
  "Lieu du projet : Gotion gigafactory, Kénitra Atlantic Free Zone (AFZ), zone franche de Kénitra. Ne confonds pas le site chantier avec les sites internes Belkora de production ou de magasin.",
